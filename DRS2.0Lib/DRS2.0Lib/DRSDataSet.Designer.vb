...
Namespace DRSDataSetTableAdapters
    ...
    Partial Public Class DRS20TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT Id, RecordingTime, RecordingLegth, Beschreibung, LinkMoreInfo, MP3OutFileN"& _ 
                "ame, StatusDone, StatusEncodeStart, StatusEncodeEnd, [Stored on CD], WMrecorderE"& _ 
            ...
            Me._commandCollection(2).CommandText = "UPDATE drs set StatusDone = True where recordingTime=?"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_RecordingTime", Global.System.Data.OleDb.OleDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "RecordingTime", Global.System.Data.DataRowVersion.Original, false, Nothing))
        End Sub
